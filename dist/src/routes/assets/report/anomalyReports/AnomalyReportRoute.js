...
const ANOMALY_REPORT_ROUTE_PATH = '/asset/report/anomalyReport/file/log';
let AnomalyReportRoute = class AnomalyReportRoute extends inversify_express_utils_1.BaseHttpController {
    ...
    async createLogAnomalyReport(logAnomalyReportRequest, res, forwardCallback) {
        try {
            this.anomalyReportService.submitAnomalyReport();
        }
        catch (err) {
        }
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof LogAnonalyReportRequest !== "undefined" && LogAnonalyReportRequest) === "function" && _a || Object, Response, Function]),
    __metadata("design:returntype", Promise)
], AnomalyReportRoute.prototype, "createLogAnomalyReport", null);
AnomalyReportRoute = __decorate([
    ...
    __metadata("design:paramtypes", [domain_1.ILogAnomalyReportService])
], AnomalyReportRoute);
